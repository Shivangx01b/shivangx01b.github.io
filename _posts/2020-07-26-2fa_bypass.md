...
So I tried to remove the captcha header from the request to see if web app is blocking any client side changes but login resquest gave me "Invalid Captcha"...But 2fa didn't !
